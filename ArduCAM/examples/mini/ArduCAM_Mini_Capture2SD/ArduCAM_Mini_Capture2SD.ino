...
void myCAMSaveToSDFile() {
  ...
  if (succ) {
    ...
    /*
     * When using in another sketch, place code here to
     * delete the failed image, subtract 1 from int k,
     * then try again if required.
     */
    Serial.println(F("FIFO length read error!"));
    return false;
  }
}
