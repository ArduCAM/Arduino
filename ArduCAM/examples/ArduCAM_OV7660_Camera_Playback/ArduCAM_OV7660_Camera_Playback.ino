...
//
// This demo was made for Omnivision OV7660 sensor.
...
void setup()
{
  ...
  if((vid != 0x76) || (pid != 0x60))
    Serial.println("Can't find OV7660 module!");
  else
    Serial.println("OV7660 detected");
