...
//
// This demo was made for Aptina MT9M112 standard camera module.
// It will turn the ArduCAM into a real digital camera with capture and playback functions.
// Before use this example, please uncomment the line #define MT9M112_CAM in the memorysaver.h file.
...
// This program requires the ArduCAM V3.4.2 (or above) library and Rev.C ArduCAM shield
...
void setup()
{
  ...
  //Check if the camera module type is MT9M112
  myCAM.wrSensorReg8_16(0xf0, 0x00);
  myCAM.rdSensorReg8_16(0x00, &vid);
  if ((vid != 0x148C))
    Serial.println("Can't find MT9M112 module!");
  else
    Serial.println("MT9M112 detected");
