...
//
// This demo was made for Aptina MT9V111 standard camera module.
// It will turn the ArduCAM into a real digital camera with capture and playback functions.
// Before use this example, please uncomment the line #define MT9V111_CAM in the memorysaver.h file.
...
// This program requires the ArduCAM V3.4.3 (or above) library and Rev.C ArduCAM shield
...
void setup()
{
  ...
  //Check if the camera module type is MT9V111
  myCAM.wrSensorReg8_16(0x01, 0x04);
  myCAM.rdSensorReg8_16(0x36, &vid);
  if ((vid != 0x823A))
    Serial.println("Can't find MT9V111 module!");
  else
    Serial.println("MT9V111 detected");
