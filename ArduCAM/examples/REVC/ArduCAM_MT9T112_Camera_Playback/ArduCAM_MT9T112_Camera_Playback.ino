...
//
// This demo was made for Aptina MT9T112 standard camera module.
// It will turn the ArduCAM into a real digital camera with capture and playback functions.
// Before use this example, please uncomment the line #define MT9T112_CAM in the memorysaver.h file.
...
// This program requires the ArduCAM V3.4.6 (or above) library and Rev.C ArduCAM shield
...
void setup()
{
  ...
  //Check if the camera module type is MT9T112
  myCAM.rdSensorReg16_16(0x0000, &vid);
  if ((vid != 0x2682))
    Serial.println("Can't find MT9T112 module!");
  else
    Serial.println("MT9T112 detected");
