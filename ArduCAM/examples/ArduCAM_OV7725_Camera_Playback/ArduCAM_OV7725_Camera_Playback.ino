...
//
// This demo was made for Omnivision OV7725 sensor.
...
// This program requires the ArduCAM V3.2.0 (or above) library and Rev.C ArduCAM shield
...
void setup()
{
  ...
  //Check if the camera module type is OV7725
  myCAM.rdSensorReg8_8(0x0A, &vid);
  myCAM.rdSensorReg8_8(0x0B, &pid);
  if((vid != 0x77) || (pid != 0x21))
    Serial.println("Can't find OV7725 module!");
  else
    Serial.println("OV7725 detected");
